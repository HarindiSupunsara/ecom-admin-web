...
export class RoleService {
  ...
  getAllRoles(status:string,limit:number,offset:number): Observable<any> {
  ...
  getAllActiveRoles(status:string): Observable<any> {
    const headers = new HttpHeaders().set("Authorization", sessionStorage.getItem("token")!);
  ...
  saveRole(instrument:any): Observable<any> {
