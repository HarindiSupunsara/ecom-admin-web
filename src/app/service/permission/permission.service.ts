...
export class PermissionService {
  ...
  getAllPermissions(status:string,limit:number,offset:number): Observable<any> {
  ...
  getAllActivePermissions(status:string): Observable<any> {
    const headers = new HttpHeaders().set("Authorization", sessionStorage.getItem("token")!);
  ...
  savePermission(instrument:any): Observable<any> {
